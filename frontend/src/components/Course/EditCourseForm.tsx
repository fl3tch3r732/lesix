...
const EditCourseForm: React.FC<EditCourseFormProps> = ({ isOpen, onClose, onCourseUpdated, course }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await coursesAPI.update(course.id, courseData);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-gray-900">Modifier le cours</h2>
          <button
            onClick={onClose}
